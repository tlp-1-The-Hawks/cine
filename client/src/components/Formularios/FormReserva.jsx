      ...
      <div className="formBoxReserva">
        ...
        <div className="inputBoxReserva">
          ...
          <div className="quantity-container">
            <button className="quantity-button" placeholder='cantidad de boletos' onClick={() => handleQuantityChange({ target: { value: quantity - 1 } })}>
            ...
            />
            <button className="quantity-button" onClick={() => handleQuantityChange({ target: { value: quantity + 1 } })}>
